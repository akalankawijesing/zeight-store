...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'CONFIRMED', 'PACKAGING', 'IN_DELIVERY', 'DELIVERED', 'RETURNED', 'FAILED');
...
-- CreateEnum
CREATE TYPE "Gender" AS ENUM ('UNISEX', 'MALE', 'FEMALE', 'KIDS');
...
-- CreateIndex
CREATE INDEX "Stock_productVariantId_idx" ON "Stock"("productVariantId");
