...
const SalesCampaignBanner = () => {
    ...
    return (
        //w-full bg-gradient-to-r from-red-600 via-orange-500 to-red-600 py-3 relative overflow-hidden
        <div className='w-full bg-black py-3 relative overflow-hidden'>
